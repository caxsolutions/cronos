...
public class ZMessManager extends RuntimeException {
	...
	public static String ENTITY_SUCCESFULLYSAVED = "Se guardaron los datos con exito.";
	public static String ENTITY_SUCCESFULLYDELETED = "Se eliminaron los datos con exito";
	public static String ENTITY_SUCCESFULLYMODIFIED = "Se modificaron los datos con exito";
