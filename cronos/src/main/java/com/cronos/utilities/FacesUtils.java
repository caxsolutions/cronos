...
public class FacesUtils {
 ...
 public static Double checkDouble(Object input) throws ZMessManager {
	...
	public static String getRealPath(String fieldPath){
		...
		try {
			...
			if(fieldPath != null && !fieldPath.isEmpty()){
				...
				rutaReal = servletContext.getRealPath(fieldPath);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void executarComponente(String accionComponente){
		RequestContext.getCurrentInstance().execute(accionComponente);
	}
